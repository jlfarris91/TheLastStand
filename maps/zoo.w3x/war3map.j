...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'Hhkl', 716.3, 900.2, 266.715, 'Hhkl')
    ...
    set u=BlzCreateUnitWithSkin(p, 'nmed', 460.6, 625.7, 267.781, 'nmed')
    ...
    set u=BlzCreateUnitWithSkin(p, 'zmar', 467.6, 472.2, 269.222, 'zmar')
    set u=BlzCreateUnitWithSkin(p, 'earc', 332.1, 1735.3, 260.592, 'earc')
    set u=BlzCreateUnitWithSkin(p, 'nvil', 225.9, 1063.5, 266.697, 'nvil')
    set u=BlzCreateUnitWithSkin(p, 'nwiz', 339.2, 618.3, 268.322, 'nwiz')
    set u=BlzCreateUnitWithSkin(p, 'nvil', 235.9, 736.8, 266.697, 'nvil')
    ...
    set u=BlzCreateUnitWithSkin(p, 'nvil', 237.8, 630.0, 266.697, 'nvil')
    ...
    set u=BlzCreateUnitWithSkin(p, 'hcth', 581.7, 903.8, 259.398, 'hcth')
    set u=BlzCreateUnitWithSkin(p, 'hfoo', 457.6, 901.1, 263.963, 'hfoo')
    set u=BlzCreateUnitWithSkin(p, 'hmil', 340.1, 897.3, 271.085, 'hmil')
    ...
    set u=BlzCreateUnitWithSkin(p, 'nvil', 233.8, 887.3, 266.697, 'nvil')
